...
with col_logo:
    if os.path.exists("Logo.png"):
        ...
        st.markdown(
            "<div style='font-size:48px;padding-top:6px;'>🛡️</div>",
            unsafe_allow_html=True,
        )
with col_title:
    st.markdown(
        "<h1 style='margin-bottom:0;'>Sistema Inteligente de Detección de Fraude</h1>"
        "<p style='color:#a0b4cc;margin-top:2px;font-size:13px;'>"
        f"Modelos cargados: {' · '.join(all_models.keys())} · Explicabilidad SHAP</p>",
        unsafe_allow_html=True,
    )
...
with tab8:
    ...
    _components.html(_pipeline_html, height=820, scrolling=False)
